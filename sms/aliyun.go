 ...
 * 创建阿里云短信结构
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
func NewAliyunSms(accessKeyId, accessKeySecret, signName string) *aliyunSms {
 ...
 * 发送手机信息
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
func (s *aliyunSms) Send(mobiles string) error {
	if len(mobiles) == 0 {
 ...
 * 设置模版参数
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
func (s *aliyunSms) SetTemplateParam(templateParam AliyunSmsTemplateParam) {
